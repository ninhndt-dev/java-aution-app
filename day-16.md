...
public class ThreadBasics {
    public static void main(String[] args) throws InterruptedException {
        ...
        t1.start();   // tạo thread mới rồi gọi run() trên đó
        t2.start();

        t1.join();    // main chờ t1 chạy xong
...
public class StartVsRun {
    public static void main(String[] args) {
        ...
        new Thread(task, "thread-B").start(); // tạo thread mới -> in "thread-B"
    }
}
```
...
public class DaemonDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        heartbeat.setDaemon(true);   // PHẢI trước start()
        heartbeat.start();
...
public class AuctionConcurrencyDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (Thread t : bidders) t.start();   // chạy SONG SONG
        for (Thread t : bidders) t.join();    // chờ tất cả xong
