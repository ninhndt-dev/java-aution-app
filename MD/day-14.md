...
public class InspectAuction {
    public static void main(String[] args) {
        Class<?> clazz = Auction.___; // Điền từ khóa lấy Class object
        System.out.println("== Class: " + clazz.getName() + " ==");

        System.out.println("\n--- FIELDS (getDeclaredFields: mọi modifier, chỉ class này) ---");
        for (Field f : clazz.____()) { // Điền phương thức lấy tất cả các trường (kể cả private)
...
public class InvokeDemo {
    public static void main(String[] args) throws Exception {
        ...
        Method m = a.____().getMethod(tenMethod, long.class); // Điền phương thức lấy Class object từ instance

        Object ketQua = m.____(a, 12_000_000L); // Điền phương thức gọi method qua reflection
...
public class PrivateAccessDemo {
    public static void main(String[] args) throws Exception {
        ...
        f.____(true); // Điền phương thức cho phép truy cập private
        long gia = (long) f.____(a); // Điền phương thức đọc giá trị từ field
        System.out.println("Giá (đọc qua reflection): " + gia);  // 5000000

        // 2) GHI thẳng vào field private — phá vỡ encapsulation!
        f.____(a, 99_000_000L); // Điền phương thức ghi giá trị vào field
...
public class FactoryDemo {
    public static void main(String[] args) throws Exception {
        ...
        Constructor<?> ctor = clazz.____(String.class, long.class); // Điền phương thức lấy constructor
        Object obj = ctor.____("Xe Vespa cổ", 30_000_000L); // Điền phương thức tạo instance
