...
public class HashMapBugDemo {
    ...
    public static void main(String[] args) {
        ___<ProductKeyBuggy, Integer> stock = new ___<>(); // Điền interface và lớp triển khai Map
...
public class HashMapFixDemo {
    ...
    static final class ProductKey {
        ...
        @Override
        public int hashCode() {
            return Objects.___(code, warehouse); // Điền phương thức tính hash từ nhiều trường
        }
    }
...
public ___ ProductKey(String code, int warehouse) { } // Điền từ khóa khai báo bản ghi
```
...
public class GroupingDemo {
    public static void main(String[] args) {
        ...
        for (Item it : items) {
            ...
            byCategory.___(it.category(), k -> new ArrayList<>()) // Điền phương thức tạo/lấy giá trị
                      .add(it.name());
        }
        ...
        for (Item it : items) {
            count.___(it.category(), 1, Integer::sum); // Điền phương thức gộp giá trị
        }
...
public class BidIndex {
    ...
    private final ___<Long, List<Bid>> bidsByUser = new ___<>(); // Điền interface và lớp triển khai
    private final ___<Long, Bid> highestByUser = new ___<>(); // Điền interface và lớp triển khai

    public void addBid(Bid b) {
        // Gom mọi bid của user: chưa có user → tạo list mới
        bidsByUser.___(b.userId(), id -> new ArrayList<>()).add(b); // Điền phương thức tạo/lấy danh sách

        // Giữ bid cao nhất: chưa có → dùng b; có rồi → so sánh giữ cái lớn hơn
        highestByUser.___( // Điền phương thức gộp giá trị
            b.userId(),
            b,
