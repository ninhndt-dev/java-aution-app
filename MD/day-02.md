...
public class MemoryDemo {
    ...
    public static void main(String[] args) {
        ...
        Point p1 = ___ Point(1, 2); // Điền từ khóa khởi tạo đối tượng
...
public class StackOverflowDemo {
    ...
    public static void main(String[] args) {
        ___ { // Điền từ khóa bắt đầu khối kiểm tra ngoại lệ
            recurse(1);
        } ___ (StackOverflowError e) { // Điền từ khóa bắt ngoại lệ
...
public class Auction {
    ...
    private final ___<Bid> bids;         // Điền interface đại diện cho danh sách
