...
public class StateDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Trước start():   " + t.___());  // Điền phương thức lấy trạng thái (NEW)
        t.start();
        System.out.println("Ngay sau start(): " + t.___()); // RUNNABLE (thường)

        t.___();  // Điền phương thức chờ worker chạy xong
        System.out.println("Sau khi xong:    " + t.___());  // TERMINATED
    }
}
```
...
public class SleepStateDemo {
    public static void main(String[] args) throws InterruptedException {
        Thread sleeper = new Thread(() -> {
            try {
                Thread.___(2000);   // Điền phương thức để luồng ngủ 2 giây
            } catch (___ e) { // Điền ngoại lệ khi bị ngắt
                Thread.currentThread().___(); // Điền phương thức ngắt luồng
            }
        });
...
public class JoinDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (Thread w : workers) {
            w.___();   // Điền phương thức chờ TỪNG worker xong (main rơi vào WAITING)
        }
...
public class InterruptDemo {
    public static void main(String[] args) throws InterruptedException {
        Thread worker = new Thread(() -> {
            ...
            while (!Thread.currentThread().___()) { // Điền phương thức kiểm tra cờ ngắt
                try {
                    ...
                    Thread.currentThread().___(); // Điền phương thức đặt lại cờ ngắt
                }
            }
...
public class AuctionLifecycleDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ___ closer = new Thread(() -> { // Điền class tạo luồng
            ...
            try {
                ...
                Thread.currentThread().___(); // Điền phương thức để ngắt luồng
