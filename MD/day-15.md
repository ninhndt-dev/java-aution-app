...
@___(RetentionPolicy.RUNTIME)    // Điền meta-annotation định nghĩa vòng đời
@___(ElementType.FIELD)             // Điền meta-annotation định nghĩa vị trí dán
public @interface Column {
...
public class ColumnScanner {
    ...
    public static void describe(Class<?> entity) {
        ...
        for (Field f : entity.getDeclaredFields()) {
            ...
            if (f.____(Column.class)) { // Điền phương thức kiểm tra sự tồn tại của annotation
                Column col = f.____(Column.class);   // Điền phương thức lấy annotation
    ...
    public static List<String> validate(Object obj) {
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            try {
                ...
                // Luật @NotNull
                if (field.____(NotNull.class)) { // Điền phương thức kiểm tra annotation
                    NotNull rule = field.____(NotNull.class); // Điền phương thức lấy annotation
                    if (value == null) {
